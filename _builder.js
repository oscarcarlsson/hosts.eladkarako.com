...
/*********************************** W R I T E   F I L E S ****************************/
  ...
  (function(){    //rewrite original files with fixe/sorted/uniqueified content, still working with the content variable (RAM) though.
    ...
    files.forEach(function(file, index){
      ...
      fs.utimesSync(file, dates[index].mtime, dates[index].atime);  //restore timestamp for modified content.
    });
  ...
  (function(index){                                              //write hosts.txt/hosts0.txt to build folder
    ...
    fs.utimesSync(HOSTS127, dates[index].mtime, dates[index].atime);  //timestamp
    fs.utimesSync(HOSTS0,   dates[index].mtime, dates[index].atime);  //timestamp
  ...
  (function(){                                                  //write adblock lists to build folder
    ...
    contents.forEach(function(content, index){
      ...
      */
      ...
      fs.utimesSync(files_target[index],  dates[index].mtime, dates[index].atime);  //timestamp
    });
